...
// "Actual" is a pure derived value — the expense-log sum for this
// subcategory, or the property's blank ($0) starting point if nothing's
// been logged yet (spec §2, rule 2). Only "Estimated" is ever user-entered;
// there is deliberately no manual override path for "Actual".
